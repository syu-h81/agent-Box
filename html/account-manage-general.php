          ...
          <div class="home-inner">
            ...
            <div class="home-account-manage__inner">
              <div class="home-account-manage__block">
                ...
                <!--<div class="home-account-manage-general-company__inner">
                  <h3 class="home-subTitle">企業情報</h3>
                  <table class="home-account-manage-general-company__table">
                    <tr class="home-account-manage-general-company__tr">
                      <th class="home-account-manage-general-company__th home-account-manage-general-company__th__name">会社名</th>
                      <td class="home-account-manage-general-company__td home-account-manage-general-company__td__name">株式会社ANCa</td>
                    </tr>
                    <tr class="home-account-manage-general-company__tr">
                      <th class="home-account-manage-general-company__th">本社所在地</th>
                      <td class="home-account-manage-general-company__td">京都府京都市中京区恵比須町439番地</td>
                    </tr>
                    <tr class="home-account-manage-general-company__tr">
                      <th class="home-account-manage-general-company__th">有料職業紹介許可番号</th>
                      <td class="home-account-manage-general-company__td">123451234</td>
                    </tr>
                  </table>
                </div>-->
              </div>
