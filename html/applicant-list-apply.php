        ...
        <div class="applicant-list__inner applicant-inner">
          <div class="applicant-list__block applicant-block">
            ...
            <div class="applicant-list-content__inner applicant-content-inner">
              ...
              <!--===== 応募選考一覧フィルター適用中 =====-->
              <div class="applicant-list-content-apply__inner">
                <div class="applicant-list-content-apply__heading">
                  <span>フィルター適用中：</span>
                </div>
                <div class="applicant-list-content-apply__block">
                  <div class="applicant-list-content-apply__box">
                    <span><?php echo $_POST['type'] ?></span>
                  </div>
                  <div class="applicant-list-content-apply__box">
