        ...
        <div class="seeker-applicant-list__inner seeker-inner">
          <div class="seeker-applicant-list__block seeker-block">
            ...
            <div class="seeker-applicant-list-content__inner seeker-content-inner">
              ...
              <div class="seeker-applicant-list-content-table-ca__inner">
                <table class="seeker-applicant-list-content-table-ca">
                  <thead class="seeker-applicant-list-content-table-ca__thead">
                    <tr class="seeker-applicant-list-content-table-ca__tr">
                      <th class="seeker-applicant-list-content-table-ca__th">フォーム回答日時</th>
                      <th class="seeker-applicant-list-content-table-ca__th">求職者名</th>
                      <th class="seeker-applicant-list-content-table-ca__th">担当CA</th>
                      <th class="seeker-applicant-list-content-table-ca__th">エラー内容</th>
                    </tr>
                  </thead>
                  <tr class="seeker-applicant-list-content-table-ca__tr">
                    <td class="seeker-applicant-list-content-table-ca__td">2024/03/28 19:00</td>
                    <td class="seeker-applicant-list-content-table-ca__td"><a href="">松井良太</a></td>
                    <td class="seeker-applicant-list-content-table-ca__td">後東健太</td>
                    <td class="seeker-applicant-list-content-table-ca__td">xxxxの情報が不足しています</td>
                  </tr>
                  <tr class="seeker-applicant-list-content-table-ca__tr">
                    <td class="seeker-applicant-list-content-table-ca__td">2024/03/28 19:00</td>
                    <td class="seeker-applicant-list-content-table-ca__td"><a href="">松井良太</a></td>
